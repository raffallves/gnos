...
describe("Language entity tests", () => {
    describe('When working with languages', () => {
        ...
        it('should remap the reading direction type', () => {
            const language = Language.create('português', ['https://www.google.com'], undefined, undefined, undefined, undefined, 'left-to-right');
        ...
        it('should correctly change the language settings', () => {
            const language = Language.create('português', ['https://www.google.com']);
            const newSettings1 = {
        ...
        it('should refuse to create an unsupported language', () => {
            expect(() => {
                const language = Language.create('mauvaisiano', ['https://www.google.com']);
            }).toThrow();
        }); 
